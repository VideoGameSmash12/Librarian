...
import me.videogamesm12.librarian.v1_12_2.legacyfabric.mixin.CreativeInventoryScreenAccessor;
	...
	public void onBackupOutcome(BackupOutcomeEvent event)
	{
		...
		else
		{
			sendActionBar(new TranslatableText("librarian.messages.backup_failed.action_bar",
					event.getException().getClass().getName()).setStyle(new Style().setFormatting(Formatting.RED)));
		}
	}
