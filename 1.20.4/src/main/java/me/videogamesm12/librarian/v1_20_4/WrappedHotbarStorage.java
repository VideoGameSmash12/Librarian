package me.videogamesm12.librarian.v1_20_4;

import me.videogamesm12.librarian.api.IWrappedHotbarStorage;
import me.videogamesm12.librarian.util.FNF;
import me.videogamesm12.librarian.v1_20_4.mixin.HotbarStorageAccessor;
...
public class WrappedHotbarStorage extends HotbarStorage implements IWrappedHotbarStorage
{
	...
	{
		super(new File(FNF.getHotbarFolder(), FNF.getPageFileName(page)).toPath(), MinecraftClient.getInstance().getDataFixer());
