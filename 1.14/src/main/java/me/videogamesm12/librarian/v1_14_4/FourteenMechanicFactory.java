...
public class FourteenMechanicFactory implements IMechanicFactory
{
	...
	{
		return new ButtonWidget(x, y, width, height, PLAIN_COMPONENT_SERIALIZER.serialize(label), button -> onClick.run());
	}
