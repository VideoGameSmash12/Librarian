...
public class ToastNotifier extends AbstractEventListener
{
	...
	public static class LibrarianToast implements Toast
	{
		...
		{
			// Draw images
			context.drawGuiTexture(RenderPipelines.GUI_TEXTURED, BACKGROUND, 0, 0, getWidth(), getHeight());
			if (type.getIcon() != null)
			{
				context.drawGuiTexture(RenderPipelines.GUI_TEXTURED, type.getIcon(), 6, 6, 20, 20);
			}
			else
			{
		...
		public enum Type
		{
			BACKUP(-16711936, Identifier.of("librarian", "toasts/backup")),
			BACKUP_FAILURE(-16776961, Identifier.of("librarian", "toasts/backup_failure")),
			CACHE_CLEARED(-22016, Identifier.of("librarian", "toasts/cache_cleared")),
			LOAD_FAILURE(-16776961, Identifier.of("librarian", "toasts/failure")),
			SAVE_FAILURE(-16776961, Identifier.of("librarian", "toasts/failure")),
			RELOAD(-22016, Identifier.of("librarian", "toasts/reload")),
			NAVIGATION(-16711936, Identifier.of("librarian", "toasts/page_selected"));
