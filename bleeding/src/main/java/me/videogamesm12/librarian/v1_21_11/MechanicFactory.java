...
package me.videogamesm12.librarian.v1_21_11;
...
public class MechanicFactory implements IMechanicFactory
{
	...
	{
		return Button.builder(createText(label), button -> onClick.run()).bounds(x, y, width, height)
				.tooltip(tooltip != null ? Tooltip.create(createText(tooltip)) : null).build();
	}
