...
package me.videogamesm12.librarian.v1_21_11.addon;
...
public class FabricAPIAddon implements IAddon
{
	...
	public void init()
	{
		...
		nextKey = KeyBindingHelper.registerKeyBinding(new KeyMapping("librarian.key.next_page",
				InputConstants.Type.KEYSYM,
				GLFW.GLFW_KEY_RIGHT_BRACKET,
				navigationCategory));
		previousKey = KeyBindingHelper.registerKeyBinding(new KeyMapping("librarian.key.previous_page",
				InputConstants.Type.KEYSYM,
				GLFW.GLFW_KEY_LEFT_BRACKET,
				navigationCategory));
		backupKey = KeyBindingHelper.registerKeyBinding(new KeyMapping("librarian.key.backup_current_page",
				InputConstants.Type.KEYSYM,
				GLFW.GLFW_KEY_B,
				actionsCategory));
