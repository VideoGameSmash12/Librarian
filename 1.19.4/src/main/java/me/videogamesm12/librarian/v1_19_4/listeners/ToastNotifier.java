...
package me.videogamesm12.librarian.v1_19_4.listeners;
...
public class ToastNotifier extends AbstractEventListener
{
	...
	public static class LibrarianToast implements Toast
	{
		...
		public enum Type
		{
			...
			NAVIGATION(0x00FF00, new Identifier("librarian", "textures/gui/sprites/toasts/page_selected.png"));
			...
			public void draw(MatrixStack matrices)
			{
				...
				{
					MinecraftClient.getInstance().getItemRenderer().renderGuiItemIcon(matrices, BOOKSHELF, 9, 8);
				}
			}
		}
	}
